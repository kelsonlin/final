BEFORE_FILE = '/home/waynelin/Desktop/WoMenShiPengYou/data_visualization/list_category_cloth_before.txt'
AFTER_FILE = '/home/waynelin/Desktop/WoMenShiPengYou/data_visualization/list_category_cloth_after.txt' 
...
def enter_dict(before_file, after_file): 
	...
	for counter in range(2, len(our_after), 1): 
		...
		our_string = our_string.split()
		after[our_string[0]] = our_string[1]
